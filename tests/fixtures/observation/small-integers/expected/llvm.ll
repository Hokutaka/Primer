...
define internal i64 @primer_check_i16(i64 %value) {
entry:
  %below = icmp slt i64 %value, -32768
  %above = icmp sgt i64 %value, 32767
  %bad = or i1 %below, %above
  br i1 %bad, label %trap, label %ok
trap:
  call void @llvm.trap()
...
define internal i64 @primer_check_u16(i64 %value) {
entry:
  %below = icmp slt i64 %value, 0
  %above = icmp sgt i64 %value, 65535
  %bad = or i1 %below, %above
  br i1 %bad, label %trap, label %ok
trap:
  call void @llvm.trap()
...
define i64 @primer.fn.average.0(i64 %arg0, i64 %arg1) {
entry:
  ...
  %tmp1 = call i64 @primer_check_u16(i64 %tmp0)
  %tmp2 = load i64, ptr %primer_right
  %tmp3 = call i64 @primer_check_u16(i64 %tmp2)
  %tmp4 = call i64 @primer_i64_add(i64 %tmp1, i64 %tmp3)
  %tmp5 = call i64 @primer_check_u16(i64 %tmp4)
  %tmp6 = call i64 @primer_i64_div(i64 %tmp5, i64 2)
  %tmp7 = call i64 @primer_check_u16(i64 %tmp6)
  %tmp8 = call i64 @primer_check_u8(i64 %tmp7)
  ret i64 %tmp8
}

define i32 @main() {
entry:
  %primer_offset = alloca i64
  %primer_reading = alloca i64
  %tmp0 = call i64 @primer_i64_sub(i64 0, i64 3)
  %tmp1 = call i64 @primer_check_i8(i64 %tmp0)
  store i64 %tmp1, ptr %primer_offset
  %tmp2 = call i64 @primer_i64_sub(i64 0, i64 32000)
  %tmp3 = call i64 @primer_check_i16(i64 %tmp2)
  store i64 %tmp3, ptr %primer_reading
  %tmp4 = load i64, ptr %primer_reading
  %tmp5 = load i64, ptr %primer_offset
  %tmp6 = call i64 @primer_check_i16(i64 %tmp5)
  %tmp7 = call i64 @primer_i64_add(i64 %tmp4, i64 %tmp6)
  %tmp8 = call i64 @primer_check_i16(i64 %tmp7)
  call i32 (ptr, ...) @printf(ptr @.fmt_i64, i64 %tmp8)
  %tmp9 = call i64 @primer.fn.average.0(i64 240, i64 80)
  call i32 (ptr, ...) @printf(ptr @.fmt_i64, i64 %tmp9)
  %tmp10 = icmp sgt i64 127, -128
  %tmp11 = select i1 %tmp10, ptr @.bool_true, ptr @.bool_false
  call i32 @puts(ptr %tmp11)
  %tmp12 = call i64 @primer_check_u16(i64 255)
