...
int64_t primer_fn_mark_0(int64_t primer_value);
...
int main(void) {
    ...
    int64_t primer_bits = primer_check_u8((_primer_bit_left_5 = 1, _primer_bit_right_5 = 7, primer_u8_shl(_primer_bit_left_5, _primer_bit_right_5)));
    printf("%lld\n", (long long)(primer_bits));
    printf("%lld\n", (long long)(primer_check_u8((_primer_bit_left_11 = primer_bits, _primer_bit_right_11 = 7, primer_u8_shr(_primer_bit_left_11, _primer_bit_right_11)))));
    ...
    printf("%lld\n", (long long)(primer_check_u8((_primer_bit_left_27 = primer_bits, _primer_bit_right_27 = 127, primer_u8_bit_and(_primer_bit_left_27, _primer_bit_right_27)))));
    ...
    printf("%s\n", ((false && (primer_check_u8((_primer_bit_left_49 = primer_bits, _primer_bit_right_49 = 1, primer_u8_shl(_primer_bit_left_49, _primer_bit_right_49))) == 0))) ? "true" : "false");
    return 0;
}
